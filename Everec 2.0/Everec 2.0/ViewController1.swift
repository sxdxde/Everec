...
class ViewController1: UIViewController, AVAudioRecorderDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    func getDirectory() -> URL {
        ...
        let customDirectory = paths[0].appendingPathComponent("CustomRecordings")
